...
INSERT IGNORE INTO `clanci` (`id`, `naslov`, `clanak`, `rezime`, `objavljen`, `pregledi`, `korisnik_id`, `kategorija_id`, `created_at`, `updated_at`, `published_at`, `deleted_at`) VALUES
...
-- Dumping data for table portal.dokumenti: ~3 rows (approximately)
/*!40000 ALTER TABLE `dokumenti` DISABLE KEYS */;
INSERT IGNORE INTO `dokumenti` (`id`, `clanak_id`, `vrsta_id`, `kategorija_id`, `naslov`, `link`, `opis`, `velicina_tekst`, `velicina_mb`, `korisnik_id`, `created_at`) VALUES
	(2, NULL, 1, 1, 'Закон о раду', 'http://localhost/portal/pub/doc/закони_ЗАКОН_О_РАДУ_35f689fb5d790f14.pdf', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam mattis, sapien in consequat ultrices, mauris orci egestas leo, eu vestibulum odio nunc non turpis. Donec vitae elementum arcu, id auctor elit. In feugiat gravida purus pulvinar bibendum. Don', NULL, NULL, 1, '2020-09-28 08:26:29'),
	(3, NULL, 3, 1, 'Општи Акт о безбедности на раду', 'http://localhost/portal/pub/doc/_Општи_Акт_о_безбедности_на_раду_7ad227d5524a3502.pdf', 'Опис 123', NULL, NULL, 1, '2020-10-16 12:29:02'),
	(4, NULL, 1, 1, 'Zakon o planiranju i izgradnji', 'http://localhost/portal/pub/doc/Закон_Zakon_o_planiranju_i_izgradnji_062f90d0f7f2a68e.pdf', 'Zakon o planiranju i izgradnji', NULL, NULL, 1, '2020-10-16 14:37:29'),
	(5, NULL, 1, 44, 'dsffsdf', 'http://localhost/portal/pub/doc/Закон_dsffsdf_513b508a75ae1208.pdf', 'vxcvx', '658.87 KB', 0.64, 1, '2020-12-06 16:02:33');
...
CREATE TABLE IF NOT EXISTS `dokumenti_kategorije` (
  ...
  KEY `Index 3` (`parent_id`,`naziv`),
  CONSTRAINT `FK_kat_dokumenta_korisnici` FOREIGN KEY (`korisnik_id`) REFERENCES `korisnici` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table portal.dokumenti_kategorije: ~44 rows (approximately)
/*!40000 ALTER TABLE `dokumenti_kategorije` DISABLE KEYS */;
INSERT IGNORE INTO `dokumenti_kategorije` (`id`, `naziv`, `parent_id`, `position`, `level`, `left`, `right`, `korisnik_id`) VALUES
	...
	(43, 'testera', 0, 24, 1, 85, 88, 1),
	(44, 'testo', 43, 1, 2, 86, 87, 1);
...
INSERT IGNORE INTO `dokumenti_vrste` (`id`, `naziv`, `korisnik_id`) VALUES
	(1, 'Закон', 1),
	(2, 'Уредба', 1),
	(3, 'Правилник', 1);
...
INSERT IGNORE INTO `kategorije` (`id`, `naziv`, `vrsta`, `korisnik_id`) VALUES
	(1, 'Вести', 'опште', 1),
	(2, 'Саопштења', 'опште', 1),
...
INSERT IGNORE INTO `komentari` (`id`, `id_clanka`, `naslov`, `korisnik`, `korisnik_ip`, `komentar`, `created_at`, `published_at`) VALUES
...
-- Dumping data for table portal.logovi: ~72 rows (approximately)
...
INSERT IGNORE INTO `logovi` (`id`, `opis`, `datum`, `izmene`, `tip`, `korisnik_id`) VALUES
	...
	(70, '43, dokumenti_kategorije - naziv: testis', '2020-12-06 15:10:43', '', 'dodavanje', 1),
	(71, '44, dokumenti_kategorije - naziv: testo', '2020-12-06 15:10:56', '', 'dodavanje', 1),
	(72, '44, dokumenti_kategorije - naziv: testo', '2020-12-06 15:25:40', 'a:0:{}', 'izmena', 1);
