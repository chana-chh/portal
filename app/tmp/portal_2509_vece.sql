...
-- Dumping data for table portal.komentari: ~2 rows (approximately)
...
-- Dumping data for table portal.korisnici: ~0 rows (approximately)
...
-- Dumping data for table portal.logovi: ~4 rows (approximately)
DELETE FROM `logovi`;
