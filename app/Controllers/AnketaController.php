...
class AnketaController extends Controller
{
    ...
    public function getUporedni($request, $response, $args)
    {
        $id = (int)$args['id'];
        $modelAnketa = new Anketa();
        $anketa = $modelAnketa->find($id);
        ...
        $ispitanici = $model->all();

        $modelTipOdgovora = new AnketaTipOdgovora();
        $tipovi = $modelTipOdgovora->all();
        $this->render($response, 'ankete/uporedni_pregled.twig', compact('anketa', 'vrste', 'tipovi', 'pitanja', 'ispitanici'));
    }
